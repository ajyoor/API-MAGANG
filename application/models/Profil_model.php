...
class Profil_model extends CI_Model
{
    ...
    {
        if( $nip != null)   {
            $this->db->select("sp.image_profil,sp.nama,sj.nama_jabatan,sp.nip,CONCAT(sp.tempat_lahir,', ', sp.tanggal_lahir) as TTL,sp.notelp,sp.email,sp.alamat,sg.nama_golongan", FALSE);
            ...
            // $this->db->join("skp_dataskp sd", "sd.nip = sp.nip");
            // $this->db->join("skp_dataskp sd", "sd.nip = sp.nip");
